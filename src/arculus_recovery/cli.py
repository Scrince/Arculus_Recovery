"""Command-line interface for Arculus Recovery."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Arculus Recovery")
    parser.add_argument("--version", action="version", version=f"Arculus Recovery {APP_VERSION}")
