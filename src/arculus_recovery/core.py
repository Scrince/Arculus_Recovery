#!/usr/bin/env python3
"""Core BIP39/BIP32 recovery and derivation engine for Arculus Recovery."""
...
def save_derived_pdf(data: Dict, path: str, root_fingerprint: str = "") -> None:
    ...
    def draw_title() -> None:
        nonlocal y
        _pdf_text(commands, margin, y, "Arculus Key Export", 13, True)
        meta = [coin, f"Arculus v{APP_VERSION}", timestamp]
        if root_fp:
