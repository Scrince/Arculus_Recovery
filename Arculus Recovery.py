...
def run_derivation(
    ...
    derivations = (
        [f"m/44'/{coin_type}'/0'", f"m/49'/{coin_type}'/0'", f"m/84'/{coin_type}'/0'"] if all_common else [base_derivation]
    )
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--all-common", action="store_true", help="Derive m/44'/coin'/0', m/49'/coin'/0', m/84'/coin'/0'.")
    p.add_argument("--script-type", choices=["auto", "p2pkh", "p2wpkh-p2sh", "p2wpkh"], default="p2wpkh")
    p.add_argument("--count", type=int, default=5)
    p.add_argument("--coin", choices=["bitcoin", "litecoin"], default="bitcoin")
